...
document.getElementById('deviceForm').addEventListener('submit', function (event) {
  ...
  fetch('get_sensor.php?device_id=' + device_id)
    ...
    .then(data => {
      ...
      latestDataDiv.innerHTML = '<h2>Latest Sensor Data for ' + data[device_id].device_name + '</h2>' +
        '<p>Humidity: ' + data[device_id].latest_sensor1_value + '</p>' +
        '<p>Ph: ' + data[device_id].latest_sensor2_value + '</p>';
